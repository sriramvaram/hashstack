                        ...
                        <div className="col-xl-8 col-lg-7">
                            <div className="blog-details__left">
                                <div className="blog-details__img">
                                    <img src="/images/resource/news-details.jpg" title='Hash Stack' />
                                ...
                                <div className="comment-one">
                                    ...
                                    <div className="comment-one__single">
                                        <div className="comment-one__image"> <img src="/images/resource/testi-thumb-1.jpg" title='Hash Stack' /> </div>
                                    ...
                                    <div className="comment-one__single">
                                        <div className="comment-one__image"> <img src="/images/resource/testi-thumb-2.jpg" title='Hash Stack' /> </div>
                                        <div className="comment-one__content">
                                            <h3>Sarah Albert</h3>
                                            <p className="blog-details__text-2">Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
                                                Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
                            ...
                            <div className="sidebar">
                                ...
                                <div className="sidebar__single sidebar__post">
                                    ...
                                    <ul className="sidebar__post-list list-unstyled">
                                        <li>
                                            <div className="sidebar__post-image"> <img src="/images/resource/news-1.jpg" title='Hash Stack' /> </div>
                                        ...
                                        <li>
                                            <div className="sidebar__post-image"> <img src="/images/resource/news-2.jpg" title='Hash Stack' /> </div>
                                            <div className="sidebar__post-content">
                                                <h3> <span className="sidebar__post-content-meta"><i
                                        ...
                                        <li>
                                            <div className="sidebar__post-image"> <img src="/images/resource/news-3.jpg" title='Hash Stack' /> </div>
                                            <div className="sidebar__post-content">
                                                <h3> <span className="sidebar__post-content-meta"><i
