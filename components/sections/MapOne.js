                ...
                <div className="branches-outer">
                    <div className="auto-container">
                        <div className="row">
                            ...
                            {/* <div className="branch-block col-lg-4 col-md-12 col-sm-12">
                                <div className="inner-box">
                                    ...
                                    <ul className="info-list">
                                        ...
                                        <li><i className="fa fa-envelope" /> <Link href="mailto:support@chromiumsolutions.com">support@chromiumsolutions.com</Link><br /></li>
                            ...
                            <div className="branch-block col-lg-4 col-md-12 col-sm-12">
                                <div className="inner-box">
                                    <h5 className="title">Andhra Pradesh</h5>
                                    <ul className="info-list">
                                        <li><i className="fa fa-phone" /> <Link href="tel:666888000">666 888 000</Link><br /></li>
                                        <li><i className="fa fa-envelope" /> <Link href="mailto:support@chromiumsolutions.com">
support@chromiumsolutions.com</Link><br /></li>
                                        <li><i className="fa fa-map-marker-alt" /> MVP Colony, Vishakhapatnam ,Andhra Pradesh, 530017, India</li>
                                    </ul>
                                </div>
                            </div>
                            {/* Branch Block */}
