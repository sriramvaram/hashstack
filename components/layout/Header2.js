            ...
            <div className="top-left">
              <ul className="list-style-one">
                ...
                <li>
                  ...
                  Dr No 1-56-12/7, Flat No F8, 3Rd Flr Hig, -63/1, Seetha Homes,
                  Mvp, Sec 1, Main Rd, Visakhapatanam, Vishakhapatnam Andhra
                  Pradesh, 530017, India
                </li>
              </ul>
            </div>
          ...
          <nav className="menu-box">
            <div className="upper-box">
              <div className="nav-logo">
                <Link href="/">
                  {/* <Image src={LogoWhite} title="Hash Stack" /> */}
                  <Image src={Dhenusya_logo_white} title="Hash Stack" />
                </Link>
              </div>
